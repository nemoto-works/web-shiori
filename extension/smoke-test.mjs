...
assert.match(contentScriptJs, /currentStickyNoteRenderSignature/);
assert.match(contentScriptJs, /getStickyNoteRenderSignature/);
assert.match(contentScriptJs, /nextRenderSignature === currentStickyNoteRenderSignature/);
assert.match(contentScriptJs, /STICKY_NOTE_DRAG_THRESHOLD_PX/);
assert.match(contentScriptJs, /Math\.hypot\(deltaX, deltaY\) < STICKY_NOTE_DRAG_THRESHOLD_PX/);
